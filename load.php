...
$columns =["usu_id", "usu_rol_id","usu_apellido", "usu_nombre", "usu_dni", "usu_telefono",  "usu_login", "usu_password", "id_direccion", "fecha_actualizacion"];
$table="usuarios";
