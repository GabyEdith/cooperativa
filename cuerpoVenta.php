...
<section id="container">
    ...
    <div class="datos_cliente">
        ...
        <form name="form_new_cliente_venta" id="form_new_cliente_venta" class="datos">
            ...
            <div class="wd30">
                <label>Identificacion (DNI,CUIL,CUIT)</label>
    ...
    <div class="datos_venta">
        ...
        <div class="datos">
            <div class="wd50">
                ...
                <p><?php echo $_SESSION['apellido']." ".$_SESSION['nombre']?></p>
            </div>
            <div class="wd50">
                <label >Acciones</label>
                <div id="acciones_venta">
                    <a href="#" class="btn_ok textcenter" id="btn_anular_venta"><i class="fas fa-ban"></i> Anular</a>
                    <a href="#" class="btn_new textcenter" id="btn_facturar_venta"><i class="far fa-edit"></i> Facturar</a>
                </div>
            </div>
        </div>
